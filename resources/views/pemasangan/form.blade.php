...
<div class='form-group'>
    ...
    <?php if(isset($pemasangan->id_pelanggan)) { ?>
        {!! Form::select('nama_pelanggan', ['' => 'Select'] + App\Libraries\Arr::list(App\pelanggan::where('deleted', 0)->get(), 'id', function($model) {
            return $model->no_pelanggan.' - '.$model->nama_pelanggan;
        }), $pemasangan->id_pelanggan, ['class' => 'form-control', 'id' => 'nama_pelanggan', 'onchange' => 'change_pelanggan()']) !!}
    <?php } else { ?>
